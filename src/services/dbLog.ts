...
export const logTypeGroupMap = {
  ...
  foundations: {
    displayName: '新創計創相關',
    logTypes: ['創立公司', '參與投資', '創立失敗', '創立退款', '創立成功', '創立得股'],
  },
  trading: {
    displayName: '交易相關',
    logTypes: [
  ...
  managers: {
    displayName: '經理相關',
    logTypes: ['辭職紀錄', '參選紀錄', '支持紀錄', '就任經理', '經理管理', '撤職紀錄'],
  },
  products: {
    displayName: '產品相關',
    logTypes: ['推薦產品', '購買產品', '推薦回饋', '消費回饋'],
  },
  profitsAndBonuses: {
    displayName: '營利與分紅相關',
    logTypes: ['員工營利', '公司營利', '營利分紅', '亂鬥營利', '礦機營利'],
  },
  taxes: {
    displayName: '稅賦相關',
    logTypes: ['季度賦稅', '繳納稅金', '繳稅逾期', '繳稅沒金', '繳稅撤單', '繳稅沒收'],
  },
  advertisings: {
    displayName: '廣告相關',
    logTypes: ['廣告宣傳', '廣告追加'],
  ...
  arenas: {
    displayName: '亂鬥相關',
    logTypes: ['亂鬥報名', '亂鬥失格', '亂鬥退款', '亂鬥加強', '亂鬥營利'],
  },
  roles: {
    displayName: '身份組相關',
    logTypes: ['身份指派', '身份解除'],
  ...
  miscellaneous: {
    displayName: '其他雜項',
    logTypes: ['驗證通過', '發薪紀錄', '營運送禮', '公司復活'],
  },
} satisfies Record<string, LOG_TYPE_GROUP>

// 金管會相關紀錄
export const fscLogTypeList = logTypeGroupMap.fsc.logTypes

// 重要的金管會相關紀錄，需要發出未讀通知給使用者
export const importantFscLogTypeList: LOG_TYPE[] = [
  '金管通告',
  '禁止舉報',
  '禁止下單',
  '禁止聊天',
